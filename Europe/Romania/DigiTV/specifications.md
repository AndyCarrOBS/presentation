# DigiTV (4iG) - Technical Specifications

## Operator Information
- **Country**: Romania
- **Operator**: DigiTV (4iG)
- **Technical Keywords**: Cable Satellite conditional access
...
Based on keywords: Cable Satellite conditional access
...
1. "DigiTV (4iG) technical specifications"
2. "DigiTV (4iG) CI+ HbbTV specifications"
3. "DigiTV (4iG) developer portal"
4. "DigiTV (4iG) API documentation"
...
- **Customer Service**: +40 31 400 4000
- **Parent Company**: 4iG (acquired from RCS&RDS)

**Note**: Contact 4iG or DigiTV business development (specifications may have changed after acquisition)
