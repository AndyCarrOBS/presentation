# M7 Canal Digitaal - Technical Specifications

## Operator Information
- **Country**: Netherlands
- **Operator**: M7 Canal Digitaal
- **Technical Keywords**: CI+ smartcards Nagravision Irdeto
...
Based on keywords: CI+ smartcards Nagravision Irdeto
...
1. "M7 Canal Digitaal technical specifications"
2. "M7 Canal Digitaal CI+ HbbTV specifications"
3. "M7 Canal Digitaal developer portal"
4. "M7 Canal Digitaal API documentation"
...
#### Conditional Access Systems
- **Nagravision**: Vendor-specific - May require NDA
  - Contact Nagravision for documentation
- **Irdeto**: Vendor-specific - May require NDA
  - Contact Irdeto for documentation
...
- **Parent Company**: M7 Group (Canal+)
- **M7 Group Contact**: info@m7group.eu
- **M7 Group Website**: https://www.m7group.eu/

**Note**: Contact M7 Group or Canal+ Luxembourg for technical specifications
...
**Exec sponsor (market-facing)**
- **Name**: Ruud Arts
- **Title**: Managing Director, CANAL+ Netherlands
- **Email**: Ruud.Arts@canal-plus.com
- **Source**: thetvplatform.zattoo.com
- **Note**: Exec sponsor (market-facing)

#### Onboarding / Device Certification

**Onboarding / Specs owner**
- **Title**: M7 platform engineering / device onboarding lead for NL
- **Note**: Onboarding / Specs owner
