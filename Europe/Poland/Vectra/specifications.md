...
- **Country**: Poland
- **Operator**: Vectra
- **Technical Keywords**: CI+ operator STBs cable delivery
...
Based on keywords: CI+ operator STBs cable delivery
...
1. "Vectra technical specifications"
2. "Vectra CI+ HbbTV specifications"
3. "Vectra developer portal"
4. "Vectra API documentation"
...
**Note**: Contact Vectra business development
...
**Market-facing product (offer)**
- **Name**: Paweł Gruszecki
- **Title**: Head of Product Offerings
- **Note**: Market-facing product (offer)
...
**TV service owner (product)**
- **Name**: Aleksandra Kozłowska
- **Title**: VOD & TV Manager (Vectra)
- **Note**: TV service owner (product)
