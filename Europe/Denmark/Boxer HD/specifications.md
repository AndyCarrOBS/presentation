# Boxer HD - Technical Specifications

## Operator Information
- **Country**: Denmark
- **Operator**: Boxer HD
- **Technical Keywords**: CI+ CAM modules DTT premium
...
Based on keywords: CI+ CAM modules DTT premium
...
1. "Boxer HD technical specifications"
2. "Boxer HD CI+ HbbTV specifications"
3. "Boxer HD developer portal"
4. "Boxer HD API documentation"
...
**Note**: Contact Boxer HD business development
...
**Market-facing commercial**
- **Name**: Jeff Vulevic Brødbæk
- **Title**: CCO (commercial/partner-facing)
- **Source**: ContactOut
- **Note**: Market-facing commercial
