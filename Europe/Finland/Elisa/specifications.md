...
- **Country**: Finland
- **Operator**: Elisa
- **Technical Keywords**: IPTV operator STBs Elisa Viihde platform HbbTV
...
Based on keywords: IPTV operator STBs Elisa Viihde platform HbbTV
...
1. "Elisa technical specifications"
2. "Elisa CI+ HbbTV specifications"
3. "Elisa developer portal"
4. "Elisa API documentation"
...
**Note**: Contact Elisa business development or partner program
...
**Market-facing content leader**
- **Name**: Ani Korpela
- **Title**: Chief Content Officer, Elisa Entertaining Services
- **Source**: INNOVATION Magazine
- **Note**: Market-facing content leader
