# Telenor Norway - Technical Specifications

## Operator Information
- **Country**: Norway
- **Operator**: Telenor Norway
- **Technical Keywords**: CI+ CAM modules operator STBs Telenor TV platform
...
Based on keywords: CI+ CAM modules operator STBs Telenor TV platform
...
1. "Telenor Norway technical specifications"
2. "Telenor Norway CI+ HbbTV specifications"
3. "Telenor Norway developer portal"
4. "Telenor Norway API documentation"
...
- **Parent Company**: Telenor Group

**Note**: Contact Telenor Group partner program or Telenor Norway business development
...
- **Title**: Needs Telenor TV platform tech director / device onboarding
- **Note**: Technology/spec owner

#### Product Leadership

**Product (TV everywhere)**
- **Name**: Sara Marazuela Reca
- **Title**: Product Manager, TV Everywhere
- **Source**: LinkedIn
- **Note**: Product (TV everywhere)

#### TV Product / Platform

**TV product/platform leadership**
- **Name**: Jette Overgaard
- **Title**: Product Director Nordic TV (Norway)
- **Source**: LinkedIn
- **Note**: TV product/platform leadership
