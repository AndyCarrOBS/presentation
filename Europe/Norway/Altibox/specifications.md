# Altibox - Technical Specifications

## Operator Information
- **Country**: Norway
- **Operator**: Altibox
- **Technical Keywords**: CI+ CAM modules cable IPTV
...
Based on keywords: CI+ CAM modules cable IPTV
...
1. "Altibox technical specifications"
2. "Altibox CI+ HbbTV specifications"
3. "Altibox developer portal"
4. "Altibox API documentation"
...
**Note**: Contact Altibox business development
...
- **Name**: Hans Bjarne Solheim
- **Title**: Head of Content Acquisition & Product Strategy / Head of Products
- **Source**: 4ig.hu
