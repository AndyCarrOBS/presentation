# Sunrise - Technical Specifications

## Operator Information
- **Country**: Switzerland
- **Operator**: Sunrise
- **Technical Keywords**: IPTV operator STBs OTT apps
...
Based on keywords: IPTV operator STBs OTT apps
...
1. "Sunrise technical specifications"
2. "Sunrise CI+ HbbTV specifications"
3. "Sunrise developer portal"
4. "Sunrise API documentation"
...
**Note**: Contact Sunrise business development
...
- **Name**: Fabrizio Campanale
- **Title**: VP / Senior Director, Entertainment & In-Home Connectivity (responsible for video platforms/services)
- **Source**: LinkedIn, Telco Magazine
- **Note**: Technology + platform ownership
