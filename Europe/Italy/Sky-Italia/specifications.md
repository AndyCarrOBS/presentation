# Sky Italia - Technical Specifications

## Operator Information
- **Country**: Italy
- **Operator**: Sky Italia
- **Technical Keywords**: NDS Videoguard CAS Sky Q hybrid STBs satellite OTT
...
Based on keywords: NDS Videoguard CAS Sky Q hybrid STBs satellite OTT
...
1. "Sky Italia technical specifications"
2. "Sky Italia CI+ HbbTV specifications"
3. "Sky Italia developer portal"
4. "Sky Italia API documentation"
...
- **Parent Company**: Sky Group (Comcast)
- **Developer Portal**: Check Sky Partner portal

**Note**: Contact Sky Italia business development or Sky Partner program
...
- **Name**: Andrea Duilio
- **Title**: CEO Sky Italia (Sky leadership page)
- **Source**: Sky Group
...
- **Title**: Need Sky Italia platform/technology leader tied to device onboarding/specs
